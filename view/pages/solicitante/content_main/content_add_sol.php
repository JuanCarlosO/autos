                        ...
                        <form id="frm_add_sol" method="post" action="#">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Fecha de solicitud</label>
                                        <input type="date" id="f_sol" name="f_sol" required="" class="form-control" value="">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label> Kilometraje </label>
                                        <input type="text" id="km" name="km" placeholder="Ej: 230123" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Nombre del solicitante</label>
                                        <input type="hidden" id="solicitante_h" name="solicitante_h" value="">
                                        <input type="text" id="solicitante_name" name="solicitante_name" class="form-control" autocomplete="off" value="" required="">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Número de placa</label>
                                        <input type="hidden" id="placa_h" name="placa_h" >
                                        <input type="text" id="placa" name="placa" class="form-control" placeholder="Ej: LXP9680" autocomplete="off" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
